export function afterWebStarted(blazor) {
    blazor.addEventListener('enhancedload', () => {
        ...
        const faStyle = document.querySelector('head style') ?? document.createElement('style');
        faStyle.innerHTML = FontAwesome.dom.css();

        if (document.querySelector('head style') === null) {
            document.querySelector('head').appendChild(faStyle);
        }
    });
}